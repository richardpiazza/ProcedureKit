...
//        testCase(ConditionTests.allTests),
        ...
        testCase(FlatMapProcedureTests.allTests),
...
//        testCase(GroupTests.allTests),
        ...
        testCase(LogChannelsTests.allTests),
        testCase(LogChannelTests.allTests),
        testCase(LogEntryTests.allTests),
        testCase(LogWriterTests.allTests),
        testCase(FlatMapProcedureTests.allTests),
        testCase(MutualExclusiveConcurrencyTests.allTests),
        testCase(MutualExclusiveTests.allTests),
