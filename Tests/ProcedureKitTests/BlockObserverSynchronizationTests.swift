...
class BlockObserverSynchronizationTests: ProcedureKitTestCase {
    ...
    static var allTests = [
        ("test__will_add_observer_synchronized_with_parent_group", test__will_add_observer_synchronized_with_parent_group),
        ("test__did_attach_synchronized", test__did_attach_synchronized),
        ("test__will_execute_synchronized", test__will_execute_synchronized),
        ("test__did_execute_synchronized", test__did_execute_synchronized),
        ("test__did_cancel_synchronized", test__did_cancel_synchronized),
        ("test__will_add_synchronized", test__will_add_synchronized),
        ("test__did_add_synchronized", test__did_add_synchronized),
        ("test__will_finish_synchronized", test__will_finish_synchronized),
        ("test__did_finish_synchronized", test__did_finish_synchronized),
    ]
